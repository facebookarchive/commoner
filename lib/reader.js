...
function ModuleReader(context, resolvers, builders, wrapper) {
    var self = this;
    ...
    wrapper = require(wrapper || "../wrappers/install");
    ...
    builders = hashCallbacks("builders", builders, wrapper);
    ...
    buildModuleP: util.cachedMethod(function(id, hex, source) {
        ...
        return Q.all([
            ...
            function finish(source) {
                ...
                return util.linkP(cacheFile, commonJsFile).then(function() {
